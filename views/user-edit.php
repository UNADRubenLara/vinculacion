...
<div class="form-edit central-fr-up" >
    <form method="POST" >
        <hr>
        <label for="username">%s</label><input id="username"  type="text" pattern="[a-zA-Z0-9]{1,20}$" name="username" placeholder="%s" value="%s"
        ...
        <hr>
        <label for="fullname">%s</label> <input id="fullname" type="text" pattern="[a-zA-ZñÑáéíóú. ]+" name="fullname"
                                                 placeholder="%s" value="%s" minlength="5" maxlength="80" size="78"
                                                 required>
        <label for="rfc">%s</label> <input id="rfc" type="text" pattern="[A-Z0-9]+" name="rfc" placeholder="%s" minlength="10" maxlength="16" value="%s"
                                     size="16" required> <br>
        <hr>
        <label for="addresslocal">%s</label> <input id="addresslocal" type="text" pattern="[a-zA-Z0-9ñÑáéíóú. #]+" name="address_street"
        ...
        <select id="companytypelist"  name="companytype" value="%s" size="1">
          ...
          <label for="phone">%s:</label><input id="phone" type="tel" value="%s" name="phone" pattern="\d{3}[\-]\d{3}[\-]\d{4}" placeholder="%s" minlength="10"
