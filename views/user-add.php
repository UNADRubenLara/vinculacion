...
<div class="form-add central-fr-up" >
    <form method="POST" >
        ...
        <label for="fullname"> ' . TXTUserFullName . '</label> <input id="fullname" type="text" pattern="[a-zA-Z0-9ñÑáéíóú\-_(#@ :,;$)]+" name="fullname"
                                                 ...
                                                 required>
        <label for="rfc">' . TXTUserRFC . '</label> <input id="rfc" type="text" pattern="[a-zA-Z0-9ñÑáéíóú\-_(#@ :,;$)]+" name="rfc" placeholder="' . TXTUserRFC . '" minlength="10" maxlength="16"
                                      required> <br>
        <hr>
        ...
        <select id="ziplist" name="idaddress" size="1"></select><br>
         ...
         <label for="branch"> ' . TXTUserBranch . '</label><input id="branch" type="text" pattern="[a-zA-Z0-9ñÑáéíóú\-_(#@ :,;$)]+" maxlength="20" minlength="4" placeholder="' . TXTmenufind . '..."
