...
<div class="form-add central-fr-up" >
    <form method="POST" >
        <hr>
        <label for="username">' . TXTusername . '</label><input id="username" type="text" name="username" placeholder="' . TXTusername . '"
        ...
        <hr>
        <label for="fullname"> ' . TXTUserFullName . '</label> <input id="fullname" type="text" name="fullname"
                                                 placeholder="' . TXTUserFullNameplacehoder . '" minlength="5" maxlength="80"
                                                 required>
        <label for="rfc">' . TXTUserRFC . '</label> <input id="rfc" type="text" name="rfc" placeholder="' . TXTUserRFC . '" minlength="10" maxlength="16"
                                      required> <br>
        <hr>
        <label for="addresslocal">' . TXTUserAddress . '</label> <input id="addresslocal" type="text" name="address_street"
        ...
        <select id="ziplist" name="idaddress" size="1"></select><br>
         ...
         <label for="branch"> ' . TXTUserBranch . '</label><input id="branch" type="text" maxlength="20" minlength="4" placeholder="' . TXTmenufind . '..."
        ...
        <label for="companytypelist">' . TXTUserSize . '</label><br>
         <select id="companytypelist" name="companytype" size="1">
          ...
          <label for="phone">' . TXTUserPhone . '</label><input id="phone" type="tel" name="phone" placeholder="' . TXTUserPhone . '" minlength="10"
